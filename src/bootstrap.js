...
import {
  ...
  op_audio_param_cancel_scheduled_values,
  op_audio_param_cancel_and_hold,
  op_audio_decode_audio_data,
  op_audio_buffer_get_channel_data,
  ...
  op_audio_node_drop,
  op_audio_set_channel_count,
  op_audio_set_channel_count_mode,
  op_audio_set_channel_interpretation,

  op_audio_create_constant_source,
  op_audio_constant_source_start,
  op_audio_constant_source_stop,
  op_audio_create_convolver,
  op_audio_convolver_set_buffer,
  op_audio_create_wave_shaper,
  op_audio_wave_shaper_set_curve,
  op_audio_create_channel_merger,
  op_audio_create_channel_splitter,
  op_audio_create_buffer,
  op_audio_buffer_copy_to_channel,
  op_offline_context_create,
  op_offline_context_start_rendering,

  // localStorage
  op_localstorage_get,
  op_localstorage_set,
  op_localstorage_remove,
